...
Design rationale + web/iOS model: [`website/src/content/docs/concepts/extensibility.md`](website/src/content/docs/concepts/extensibility.md).
...
- **Food / pantry inventory** — SHIPPED (web) 2026-06-30 → 2026-07-01 (build #2). Track what's on
  ...
  (barcode/scanner scripts). See [`website/src/content/docs/reference/features.md`](website/src/content/docs/reference/features.md) (Pantry rows).
