...
- **Local-only, buildable now:** **6.7 kiosk reminders** (local "due soon" banner +
  ...
  events; Phase 1 shipped), **chore photo-proof** (6.1 tail — now just a consumer of the
  shipped 6.5 blob upload),
