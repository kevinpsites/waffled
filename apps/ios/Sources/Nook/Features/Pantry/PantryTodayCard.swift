...
struct PantryTodayCard: View {
    ...
    private var attention: [NookAPI.PantryItem] {
    ...
    private func qtyLabel(_ item: NookAPI.PantryItem) -> String? {
    ...
    @ViewBuilder private func statusTag(_ item: NookAPI.PantryItem) -> some View {
