...
final class FamilyNightModel {
    private(set) var view: NookAPI.FamilyNightView?
...
struct FamilyNightCard: View {
    ...
    private func partRow(_ a: NookAPI.FamilyNightAssignment, members: [NookAPI.FamilyNightMember]) -> some View {
        HStack(spacing: 10) {
    ...
    private func personPicker(_ a: NookAPI.FamilyNightAssignment, members: [NookAPI.FamilyNightMember]) -> some View {
        Menu {
