...
final class CountdownsModel {
    private(set) var items: [NookAPI.Countdown] = []
    ...
    func remove(_ c: NookAPI.Countdown) async {
    ...
    var byDate: [String: [NookAPI.Countdown]] { Dictionary(grouping: items, by: \.date) }
}
...
struct CountdownsCard: View {
    ...
    private func row(_ c: NookAPI.Countdown) -> some View {
