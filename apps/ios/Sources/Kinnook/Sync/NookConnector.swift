...
/// Bridges PowerSync to our backend — the Swift twin of the web `NookConnector`.
///
...
final class NookConnector: PowerSyncBackendConnectorProtocol, @unchecked Sendable {
