...
struct PlanWeekSheet: View {
                    ...
                    WaffledCard(padding: 14) {
                        HStack {
                            ...
                            Menu {
                                ...
                                WaffledMenuPill(text: cookingForLabel)
                            }
                        }
                    }
    ...
    private func draft(dates: [String], avoid: [String], full: Bool) async {
        ...
        do {
            ...
            var resolved: [WaffledAPI.PlanCardDTO] = []
    ...
    private func libraryFallback(date: String, used: Set<String>) -> WaffledAPI.PlanCardDTO? {
        guard let r = recipes.recipes.first(where: { !used.contains(normTitle($0.title)) }) else { return nil }
        return WaffledAPI.PlanCardDTO(
