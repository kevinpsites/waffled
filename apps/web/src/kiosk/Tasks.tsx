...
function draftFrom(i: ChoreInstance): ChoreDraft {
  return { id: i.choreId, instanceId: i.id, title: i.choreTitle, emoji: i.emoji, personId: i.personId, rewardAmount: i.rewardAmount, rewardCurrency: i.rewardCurrency, rrule: i.rrule, dueOn: i.dueOn, dueTime: i.dueTime, requiresApproval: i.requiresApproval, requiresPhoto: i.requiresPhoto }
}
