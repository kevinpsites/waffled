...
const PATHS = {
  ...
  // Weekly Planning. Deliberately not `calendar` — the rail carries both, and two
  // identical glyphs would make the two destinations unreadable at a glance.
  planning: '<rect x="3" y="4.5" width="18" height="16" rx="3"/><path d="M3 9.5h18M8 2.5v4M16 2.5v4"/><path d="M8.5 14.5l2.4 2.4 4.6-5"/>',
