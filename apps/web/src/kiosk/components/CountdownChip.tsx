...
// deep-link to their event (they carry the event id); standalone/birthday ones
// are informational (managed on the countdown / member profile).
export function CountdownChip({ c, onOpen }: { c: Countdown; onOpen?: (c: Countdown) => void }) {
  const clickable = !!onOpen && c.source === 'event'
