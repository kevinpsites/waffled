...
//
// The fields matched are the ones the row actually SHOWS: its name, whatever header
// it sits under (a custom list's section, a grocery row's aisle), its quantity, and
// the store it's tagged with. Searching a field the user can't see would return
// results they can't explain.
//
