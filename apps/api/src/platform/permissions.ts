...
export const DEFAULT_PERMISSIONS: Record<MemberRole, Record<Capability, boolean>> = {
  ...
  caregiver: { 'chore.manage': true, 'chore.approve': true, 'reward.manage': false, 'reward.approve': true, 'reward.grant': false, 'goal.manage': false },
  guest: { 'chore.manage': false, 'chore.approve': false, 'reward.manage': false, 'reward.approve': false, 'reward.grant': false, 'goal.manage': false },
