...
export type Capability = 'chore.manage' | 'chore.approve' | 'reward.manage' | 'reward.approve'
export const CAPABILITIES: Capability[] = ['chore.manage', 'chore.approve', 'reward.manage', 'reward.approve']
