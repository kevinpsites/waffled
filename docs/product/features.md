...
| Pantry: **allergen warnings** — household avoid-list ∪ per-person allergens, red flags + "affects X" | ✅ | ✅ | ✅ | ✅ Done — iOS **colored allergen badges** (G/D/S…, red ring when avoided) on cards + a legend; "Contains" / "⚠ Affects {people}" + "may contain" traces on the detail |
