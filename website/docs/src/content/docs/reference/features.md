...
| **Share list** — grocery handoff to a phone (text / share sheet / QR) | ✅ | — | — | ✅ Done (web/kiosk; the QR encodes the list text itself, so no app or account is needed on the phone) |
