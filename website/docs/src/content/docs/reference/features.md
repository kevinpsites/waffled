...
| **Goal tiers** — Spotlight (one hero per list) / Pinned band / More (A–Z), with a Spotlight-Pinned-Normal picker on the create/edit form | ✅ | 🟡 | 🟡 | 🟡 Web done; iPhone/iPad pending (Pinned drag-reorder + Today-card pinning on roadmap) |
