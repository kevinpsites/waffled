...
- 🗓️ **A target for this week** — set one in [Weekly Planning](/features/weekly-planning/)'s Goals step ("10 hours this week toward 750") and the goal's card on the Goals page and the Today goal card show it: **This week: 3 of 10 hours**, or **Week of Sep 21: 10 hours** until that week starts. Running counts and totals take one; habits already have a per-period target.
