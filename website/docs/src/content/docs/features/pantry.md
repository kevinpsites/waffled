...
- 📷 **Uploaded photos keep working after their links expire.** The item stores the
  upload key and refreshes the link when needed. Existing uploaded photos are migrated
  automatically; Open Food Facts image links are unchanged.
